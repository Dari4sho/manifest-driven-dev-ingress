...
export const TLS_DIR = path.join(ROOT_DIR, '.ingressctl', 'tls');
export const TLS_CERT_FILE = path.join(TLS_DIR, 'local-cert.pem');
export const TLS_KEY_FILE = path.join(TLS_DIR, 'local-key.pem');
export const TLS_ROOT_CA_FILE = path.join(TLS_DIR, 'rootCA.pem');
export const TLS_HOSTS_FILE = path.join(TLS_DIR, 'hosts.txt');
export const TLS_DYNAMIC_FILE = path.join(DYNAMIC_DIR, 'tls-local.yml');
